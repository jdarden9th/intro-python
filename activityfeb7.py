...
#this is my awnser i think computer programing is writing codes that shows the computer how to do different things
# 2. Name three (3) data types
#this is my awnser float,string, and integer
# 3. Name three (3) python Operators
#this is my awnser expoinets,<=<>=,true or false
# 4. In your own words, what is a variable?
#this is my awnser it is a container 
# READING PROMP
...
#this is my awnser this woudl be logical because both statments are true 
...
# Which python operator would you use in this situation? Explain why.
#this is my awnser assiment to assign the price to the cart
apple=10.00
socks-20.00
books=15.00
...
# Which python operator would you use in this situation? Explain why
#this is my awnser comperison because we want to see if they are the same
