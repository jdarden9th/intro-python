...
#3. Explain what compelity and abstraction are, then 
...
#abstract in coding is to show strings in different coding ways and compleity is the amount of time 
#the abstract manages the complecity by deleting any uneededinformation  
#5. What is a variable?  
#something that stores data varibles. A+B could be 5+10
#6. Write a function in Python that when called will print out 
# your name. 
#print(f'my name is'(jamir)

#7. What is a function definition and a function call?
#a block code which only works when it is called

#8. Describe what each symbol means?

# = // single equal it means ture or false 
# == // double equal it checks if the values or equal or not 
# != // exclaimation equal it means it is not equal
...
#carmel case, snake case, pascal case,
